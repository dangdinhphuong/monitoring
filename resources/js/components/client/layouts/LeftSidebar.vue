        ...
        <div class="sidebar-scroll">
            ...
            <nav id="left-sidebar-nav" class="sidebar-nav">
                <ul id="main-menu" class="metismenu">
                    ...
                    <li><a href="app-taskboard.html"><i class="icon-tag"></i><span>Tables</span></a></li>
                    <li>
                        <a href="#Widgets" class="has-arrow"><i class="icon-puzzle"></i><span>Config</span></a>
                        <ul>
                            <li><a href="widgets-statistics.html">General</a></li>
                            <li><a href="widgets-data.html">Info</a></li>
                        </ul>
                    </li>
