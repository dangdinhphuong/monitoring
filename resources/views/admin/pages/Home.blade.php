                    ...
                    <div class="card" style="height: 80vh">
                        <div class="header bline">
                            <div class="form-group col-lg-3 col-3">
                                <select class="form-control" id="exampleFormControlSelect1" onchange="setType()">
                                    <option value="bar">Bar</option>
                                    <option value="line">Line</option>
                                </select>
                            </div>
                            <ul class="header-dropdown dropdown dropdown-animated scale-left">
                                <li><h3 class="time"></h3></li>
                            </ul>
                        </div>
                        <div class="body">
{{--                            <canvas id="myChart"--}}
{{--                                    style="height: 500px!important; display: block; box-sizing: border-box; width: 1564px;"--}}
{{--                                    width="1564" height="500px"></canvas>--}}
    ...
    <div class="hidden" style="display: none;" id="main-content">
        <div class="block-header">
            <div class="row clearfix">
                <div class="col-md-6 col-sm-12">
                    <h2>Dashboard</h2>
                ...
                <div class="col-lg-8 col-md-12">
                    <div class="card">
                        <div class="header bline">
                            ...
                            <ul class="header-dropdown dropdown dropdown-animated scale-left">
                                <li><a class="btn btn-default btn-sm" href="javascript:void(0);" data-toggle="tooltip"
                                       data-placement="top" title="Monthly">Monthly</a></li>
                                <li><a class="btn btn-outline-primary btn-sm" href="javascript:void(0);"
                                       data-toggle="tooltip" data-placement="top" title="Yearly">Yearly</a></li>
                            </ul>
                        </div>
                        <div class="body">
            ...
            <div class="row clearfix">
                                        ...
                                        <div class="media">
                                            ...
                                            <div class="media-body">
                                                <span class="name">@Isabella <small
                                                        class="float-right">1 hours ago</small></span>
                                        ...
                                        <div class="media">
                                            ...
                                            <div class="media-body">
                                                <span class="name">@Alexander <small
                                                        class="float-right">1 day ago</small></span>
                ...
                <div class="col-lg-4 col-md-12">
                    <div class="card">
                        ...
                        <div class="body social_counter">
                            <ul class=" list-unstyled basic-list">
                                <li><i class="fa fa-facebook-square m-r-5"></i> FaceBook <span
                                        class="badge badge-primary">16,785</span></li>
                                <li><i class="fa fa-twitter-square m-r-5"></i> Twitter <span class="badge-purple badge">2,365</span>
                                </li>
                                <li><i class="fa fa-linkedin-square m-r-5"></i> Linkedin<span
                                        class="badge-success badge">9,021</span></li>
                                <li><i class="fa fa-google-plus-square m-r-5"></i> Google Plus<span
                                        class="badge-info badge">725</span></li>
                                <li><i class="fa fa-behance-square m-r-5"></i> Behance<span class="badge-info badge">1,725</span>
                                </li>
                                <li><i class="fa fa-dribbble m-r-5"></i> Dribbble<span
                                        class="badge-info badge">11,725</span></li>
                            </ul>
                        </div>
                    </div>
                    <div class="card">
