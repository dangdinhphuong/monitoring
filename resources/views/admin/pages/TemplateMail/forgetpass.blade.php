                ...
                <div class="u-row"
                    ...
                    <div style="border-collapse: collapse;display: table;width: 100%;background-color: transparent;">
                        ...
                        <td align="center" width="500"
                            style="background-color: #f7fbfc;width: 500px;padding: 0px;border-top: 0px solid transparent;border-left: 0px solid transparent;border-right: 0px solid transparent;border-bottom: 0px solid transparent;border-radius: 0px;-webkit-border-radius: 0px; -moz-border-radius: 0px;"
                            valign="top"><![endif]-->
                        <div class="u-col u-col-100"
                             style="max-width: 320px;min-width: 500px;display: table-cell;vertical-align: top;">
                            <div
                                style="background-color: #f7fbfc;width: 100% !important;border-radius: 0px;-webkit-border-radius: 0px; -moz-border-radius: 0px;">
                                <!--[if (!mso)&(!IE)]><!-->
                                <div
                                                ...
                                                <table width="100%" cellpadding="0" cellspacing="0" border="0">
                                                    <tr>
                                                        <td style="padding-right: 0px;padding-left: 0px;"
                                                            ...
                                                            <img align="center" border="0" src="{{configByKeyHelper('LOGO')->value }}"
                                                                 alt="Cart Icon"
                                                                 title="Cart Icon"
                                                ...
                                                <div
                                                    ...
                                                    <p style="font-size: 14px; line-height: 140%;"><span
                                                            style="font-size: 18px; line-height: 25.2px; font-family: Montserrat, sans-serif;"><strong><span
                                                                    style="line-height: 25.2px; font-size: 18px;">Đặt lại mật khẩu!</span></strong></span>
                                                    </p>
                                                </div>
                                    ...
                                    Xin chào {{$data['user']->fullname}}, chúng tôi nhận được yêu cầu thay đổi mật khẩu.</span>
                                                    </p>
                                                    <p style="font-size: 14px; line-height: 140%;"><span
                                                            style="font-family: Montserrat, sans-serif; font-size: 14px; line-height: 19.6px;">Mật khẩu đăng nhập của bạn là : </span>
                                                    </p>
                                                </div>
                                                    ...
                                                    <tr>
                                                        <td style="font-family:arial,helvetica,sans-serif;"
                                                            ...
                                                            <v:roundrect xmlns:v="urn:schemas-microsoft-com:vml"
                                                                         ...
                                                                         style="height:36px; v-text-anchor:middle; width:164px;"
                                                                         arcsize="11%" stroke="f" fillcolor="#000000">
                                                                <w:anchorlock/>
                                                                <center
                                                                    style="color:#FFFFFF;font-family:arial,helvetica,sans-serif;">
                                                    <![endif]-->
                                                    <div
                                                       style="box-sizing: border-box;display: inline-block;font-family:arial,helvetica,sans-serif;text-decoration: none;-webkit-text-size-adjust: none;text-align: center;color: #FFFFFF; background-color: #000000; border-radius: 4px;-webkit-border-radius: 4px; -moz-border-radius: 4px; width:auto; max-width:100%; overflow-wrap: break-word; word-break: break-word; word-wrap:break-word; mso-border-alt: none;">
                                  <span style="display:block;padding:10px 20px;line-height:120%;"><span
                                          style="font-family: Montserrat, sans-serif; font-size: 14px; line-height: 16.8px;"><strong>{{ $data['password'] }}</strong></span></span>
                                                    </div>
